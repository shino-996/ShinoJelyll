...
![](https://olytnha18.qnssl.com/2017-01-19-多系统启动U盘分区方案-分区.gif)
...
![](https://olytnha18.qnssl.com/2017-01-19-多系统启动U盘分区方案-制作Mac安装盘.gif)
...
![](https://olytnha18.qnssl.com/2017-01-19-多系统启动U盘分区方案-生成PE文件.gif)

再回到Windows系统，打开PE制作程序，这里不用程序中的自动制作，而是提取出iso文件。把提取出来的iso文件挪到mac系统中。

![](https://olytnha18.qnssl.com/2017-01-19-多系统启动U盘分区方案-复制PE.gif)

进入Mac系统，挂载PE的iso镜像，将里面的所有文件复制到U盘的**第二个**分区中。

## 设置MBR与PBR扇区

![](https://olytnha18.qnssl.com/2017-01-19-多系统启动U盘分区方案-编辑扇区.gif)
...
![](https://olytnha18.qnssl.com/2017-01-19-多系统启动U盘分区方案-安装Windows.jpg)
...
![](https://olytnha18.qnssl.com/2017-01-19-多系统启动U盘分区方案-提取Windows的EFI文件.gif)
...
![](https://olytnha18.qnssl.com/2017-01-19-多系统启动U盘分区方案-复制EFI文件.gif)

之后打开DiskGenius（我直接在U盘中的PE里打开的），将U盘的**第二个**分区设为激活分区，再将**第二、第三个**分区的标识均改成`EF`。

![](https://olytnha18.qnssl.com/2017-01-19-多系统启动U盘分区方案-隐藏EFI分区.gif)
...
![](https://olytnha18.qnssl.com/2017-01-19-多系统启动U盘分区方案-Mac上的EFI引导.jpg)
...
![](https://olytnha18.qnssl.com/2017-01-19-多系统启动U盘分区方案-添加EFI引导.gif)
